...
DEFINE CLASS ZintStructure AS Custom
	...
	PROCEDURE Init (ZintVersion AS String)
		...
		TEXT TO m.ZS NOSHOW FLAGS 1 PRETEXT 3
			...
			BitmapPointer,30104,30260,30364,30448,30504,30568
			BitmapWidth,30108,30264,30368,30452,30508,30572
			BitmapHeight,30112,30268,30372,30456,30512,30576
			AlphamapPointer,30116,30272,30376,30460,30516,30580
			BitmapByteLength,30120,30276,30380,-,-,-
			VectorPointer,30128,30380,30384,30464,30520,30584
			Debug,30132,520,524,536,536,536
			WarnLevel,30136,516,520,532,532,532
			MemFile,-,-,-,-,30524,30588
			MemFileSize,-,-,-,-,30528,30592
		ENDTEXT
